...
import { User, Camera, Save, Lock, Mail, Phone, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              {profile?.loyalty_points !== undefined && (
                <p className="text-amber-400 mt-2">🎁 Loyalty Points: {profile.loyalty_points}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleProfileUpdate} className="bg-white/10 backdrop-blur-md rounded-xl p-6 mb-6 border border-white/10">
          ...
          <div className="mb-4">
            <label className="block text-gray-300 mb-2">Preferences & Special Requests</label>
            <textarea
              value={preferences}
              onChange={(e) => setPreferences(e.target.value)}
              rows={3}
              className="w-full px-4 py-2 bg-gray-800 text-white rounded-lg border border-gray-700 focus:border-amber-400 focus:outline-none"
              placeholder="E.g., Non-smoking room, high floor, extra pillows..."
            />
          </div>
        ...
        {/* Change Password */}
        <form onSubmit={handlePasswordChange} className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10">
          <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
