      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-10">
          ...
          <div className="mt-6 flex space-x-4">
            ...
            <Link
              href="/guest/my-bookings"
              className="bg-gray-100 text-blue-600 px-6 py-2 rounded-lg font-medium hover:bg-gray-200 transition"
            >
              Manage bookings
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <Link
            href="/guest/profile/preferences"
            className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:bg-blue-50 transition"
          >
            <span className="text-3xl mb-2">🌟</span>
