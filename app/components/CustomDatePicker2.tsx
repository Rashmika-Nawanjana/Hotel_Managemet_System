...
const CustomDatePicker2: React.FC<CustomDatePicker2Props> = ({ value, onChange, placeholder }) => {
        ...
        <div ref={calendarRef} className="absolute top-full mt-2 w-auto bg-[#181d28] border border-gray-700 rounded-md shadow-lg z-10">
          <DayPicker
            ...
            classNames={{
              ...
              day: 'h-9 w-9 p-0 font-normal text-gray-300 hover:bg-amber-500/20 rounded-md',
