...
const NavBar = () => {
  ...
  const linkStyle = isScrolled ? 'font-l font-medium  text-gray-600 hover:text-amber-400 text-sm' : 'font-l font-medium text-amber-400 hover:text-gray-100 text-sm';
    ...
    >
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="font-semibold flex items-center space-x-4">
          {/* Use the new LoginButton component */}
